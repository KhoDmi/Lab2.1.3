...
Matrix::Matrix()
{
	numofStrings = 2;
	numofColomns = 2;
	element = new double* [numofStrings];
...
{
	numofColomns = m.numofColomns;
	numofStrings = m.numofStrings;
	element = new double* [numofStrings];
	for (int count = 0; count < numofStrings; count++)
		element[count] = new double[numofColomns];
	for (int i = 0; i < numofStrings; i++)
...
void Matrix::getMatrix()
{
	...
	{
		for (int j = 0; j < numofColomns; j++)
			cout << element[i][j]<< setprecision(2)  << "    ";
		cout << endl;
	}
...
{
	cout << "element ["<<i<<"]["<<j<<"] "<< setprecision(2) << element[i][j] << "    " << endl;
}
